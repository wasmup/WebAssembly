...
func main() {
	t := time.Now()
	window.Set("isPrime", js.FuncOf(isPrime))
	window.Set("Factorial", js.FuncOf(Factorial))
	window.Set("TimeNow", js.FuncOf(TimeNow))
	window.Set("Length", js.FuncOf(Length))
	// window.Set("clr", js.FuncOf(clr))
	// window.Set("bracket", js.FuncOf(bracket))
	// window.Set("clrHistory", js.FuncOf(clrHistory))
	// window.Set("apnd", js.FuncOf(apnd))
	// window.Set("solve", js.FuncOf(solve))
	// his.Set("value", "WebAssembly is here, ready.")
