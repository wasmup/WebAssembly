...
export function hello(name) {
    try {
        var ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
...
* @returns {string}
*/
export function factorial_big(n) {
    try {
        wasm.factorial_big(8, n);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
export function square(v) {
    var ptr0 = passArray32ToWasm0(v, wasm.__wbindgen_export_1);
    var len0 = WASM_VECTOR_LEN;
    wasm.square(8, ptr0, len0);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
