...
* @returns {Int32Array}
*/
export function to_vec(s) {
    var ptr0 = passStringToWasm0(s, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    var len0 = WASM_VECTOR_LEN;
    wasm.to_vec(8, ptr0, len0);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
...
export function insertion_sort(a) {
    try {
        ...
        a.set(getInt32Memory0().subarray(ptr0 / 4, ptr0 / 4 + len0));
        wasm.__wbindgen_export_0(ptr0, len0 * 4);
    }
}
